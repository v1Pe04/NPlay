                    ...
                    <li>
                        ...
                        <div class="setting beta">
                            <div class="setting-wrapper-grid">
                                ...
                                <label class="switch">
                                    <input type="checkbox" <?php if ($user_data['anon_comments'] == 1) : ?> checked <?php endif; ?>>
                                    <a class="slider round" href="apps/setting.php?type=accountsetting&value=anonComments"></a>
                                </label>
                            </div>
                        </div>
                        <div class="setting beta">
                            <div class="setting-wrapper-grid">
                                ...
                                <label class="switch">
                                    <input type="checkbox" <?php if ($user_data['private_profile'] == 1) : ?> checked <?php endif; ?>>
                                    <a class="slider round" href="apps/setting.php?type=accountsetting&value=privateProfile"></a>
                                </label>
                            </div>
                        </div>
                        <div class="setting beta">
